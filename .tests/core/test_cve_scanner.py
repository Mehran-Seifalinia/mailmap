...
class TestCVEScanner(unittest.TestCase):
    ...
    def setUp(self):
        # Patch create_session to avoid real HTTP sessions
    ...
    def test_perform_test_get_post(self, mock_post, mock_get):
        scanner = CVEScanner()
        # Mock GET success with matching evidence
        ...
        # Mock POST success without evidence regex
    ...
    def test_scan_basic(self, mock_read_json, mock_perform_test):
        # Setup CVE data with one valid entry
        mock_read_json.return_value = [{
            "id": "CVE-2023-1234",
        ...
        # Invalid CVSS format triggers warning
    ...
    def test_scan_with_missing_url_and_path(self, mock_read_json, mock_perform_test):
        # test with no url and no path in test info -> not_tested
        mock_read_json.return_value = [{
            "id": "CVE-123",
            "description": "desc",
            "cvss": "7.0",
    ...
    def test_scan_with_invalid_base_url(self, mock_read_json, mock_perform_test):
        # base_url is invalid, path provided -> not_tested
        mock_read_json.return_value = [{
            "id": "CVE-1234",
            "description": "desc",
            "cvss": "4.0",
